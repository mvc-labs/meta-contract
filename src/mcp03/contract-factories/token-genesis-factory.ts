...
import { PROTO_FLAG, TOKEN_NAME_LEN, TOKEN_SYMBOL_LEN } from '../constants.js'
...
export class TokenGenesisFactory {
  ...
  public static create({ tokenName, tokenSymbol, decimalNum, address }) {
    ...
    const TOKEN_SYMBOL = Buffer.alloc(TOKEN_SYMBOL_LEN, 0)
